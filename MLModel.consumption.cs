...
namespace App_example
{
    public partial class MLModel
    {
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"OverallPaxAmount_LB")]
            public float[] OverallPaxAmount_LB { get; set; }

            [ColumnName(@"OverallPaxAmount_UB")]
            public float[] OverallPaxAmount_UB { get; set; }

        }

        #endregion

        private static string MLNetModelPath = Path.GetFullPath(@"C:\Users\Tine Cacapit\Documents\WiiBand\MLModel.mlnet");
